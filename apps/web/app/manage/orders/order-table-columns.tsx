...
const orderTableColumns: ColumnDef<OrderItem>[] = [
  ...
  },
  {
    ...
    cell: function Cell({ row }) {
      const { orderObjectByGuestId } = React.useContext(OrderTableContext);
  ...
  },
  {
    ...
    header: "Trạng thái",
    cell: function Cell({ row }) {
      const { changeStatus } = React.useContext(OrderTableContext);
  ...
  },
  {
    ...
    cell: function Actions({ row }) {
      const { setOrderIdEdit } = React.useContext(OrderTableContext);
      const openEditOrder = () => {
